...
use App\Mail\KodeVertifikasiPenarikanMail;
...
class VertifPenarikanController extends Controller
{
    public function requestCode(Request $request){
        try {
            ...
            $user = UserGuru::where('email', $email)->first();
            if (!$user) {
            ...
            Mail::to($email)->queue(new KodeVertifikasiPenarikanMail($code));

            return response()->json(['message' => 'Kode telah dikirim ke email.']);
        } catch (\Exception $e) {
