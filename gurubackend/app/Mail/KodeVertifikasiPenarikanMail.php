...
class KodeVertifikasiPenarikanMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Kode Verifikasi Penarikan Anda',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.veritifikasi_penarikan', // view email
